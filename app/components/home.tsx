    ...
    >
      ...
      <div className={styles["window-content"]} id={SlotID.AppBody}>
        <Routes>
          ...
          <Route path={Path.ContentManagement} element={<ContentManagement />} />
        </Routes>
      </div>
    </div>
  );
...
function ScreenUser() {
  ...
  return (
    ...
    >
      <SideBarUser className={isHome ? styles["sidebar-show"] : ""} />
...
export const Home:React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log(data.get('username') === 'admin');
  ...
  let ui = <Login onSubmit={handleSubmit}/>;
  if(login === 1) ui = <Screen />;
  if(login === 2) ui = <ScreenUser />
